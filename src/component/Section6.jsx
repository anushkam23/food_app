...
export default function Section6() {
  ...
  <div className="sixthcat" id="Section6" ref={Section6} style={{height: '1007px', width: '100%', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
   </div>
